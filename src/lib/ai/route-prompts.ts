...
要求:
- 站在商业网文编辑和当代网文读者角度判断：先修事实、动机、因果和追读阻力，再修表达
- 提升网感，但不把所有句子切成短句，不把原文改成统一模板
- 保留原情节和角色行为不动
- 用户未要求时不强行控制字数
- 默认先输出完整修订正文；修改要点由调用方另行要求时再给出`,
...
编辑目标:
1. 尽快让读者看见人物处境、目标或异常，但不把前三句或五百字当成死线
2. 每章都要有明确的阅读回报，可以是爽、好奇、紧张、关系拉扯或情绪回报
3. 章末留下具体的行动、信息、选择或风险；钩子必须有正文因果
4. 不用大段无功能的景物和设定说明，但有功能的环境和日常可以保留
5. 用前几章建立主角的问题处境和持续追读理由，不强行塞金手指或反转
...
角色卡至少要让读者和作者知道：
- 这个人在当前故事中的剧情功能
- 他/她主动想得到什么，现实中谁或什么在阻止
- 他/她拥有的资源、代价和不能轻易跨过的底线
- 与关键人物的利益冲突或关系张力
- 能在正文里被写出来的行动习惯、语言差异或辨识度

姓名、年龄、外貌、创伤、成长弧、口头禅和秘密按角色重要程度补充；没有剧情用途就不要硬填。
...
- 网文快节奏:优先压缩无效过渡，提高有效变化密度；不规定固定字数或钩子间隔
- 文学性:重心理描写和意象,节奏慢
- 日轻:内心独白中二,吐槽役多
- B站故事:口语化,情绪输出强,反转密集
- 每个技能提供倾向和参考，不自动覆盖事实、角色行为、用户意图或场景需要；除非用户明确要求，不把技能变成固定字数、固定节拍或固定句式`,
